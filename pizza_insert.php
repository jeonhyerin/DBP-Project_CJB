<?
	...
	$sql = "insert into pizza(name, password, subject, content, hit, regist_day, file_name_0, file_copied_0, file_name_1, file_copied_1, file_name_2, file_copied_2, file_name_3, file_copied_3)
...
?>
	...
	echo ("
		...
		location.href='pizza_list.php?num=$num';
		</script>
	");
